    ...
    <section>
      <div class="container mx-auto">
        <div class=" grid grid-cols-6 flex-col gap-6 md:grid-cols-2 lg:grid-cols-4 ">
          {/* Page 1 */}
          <div
            class=" col-start-1 col-end-7 mx-auto h-full w-full max-w-screen-2xl flex-shrink-0 bg-cover bg-center bg-no-repeat"
            dir="ltr"
          >
            <div class="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
              <div class="flex-1 space-y-4 sm:text-center lg:text-left">
                <div class="  mx-auto h-full w-full max-w-screen-xl bg-otmobile bg-cover bg-center bg-no-repeat sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
                  <video
                  ...
                  <div class="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
                    ...
                    <p class="ml-10 mt-4 block w-full max-w-lg rounded bg-black text-center font-primary text-white opacity-70 sm:text-xl/relaxed">
                      ...
                      bustling era, wherein large vessels navigate busy sea
                      routes and the power of steam gives birth to new
                      technologies. Some people thrill to glamorous stars of the
                      stage and industry, while others are brought to tears by
                      war, plague, and poverty. In this faraway realm, eight
                      travelers hailing from different regions venture forth for
                      their own reasons. Step into their shoes and explore the
                      land as you see fit, using their unique talents to aid you
          ...
          <div class=" col-start-1 col-end-7 mx-auto h-full w-full max-w-screen-2xl flex-shrink-0 bg-map11 bg-cover bg-center bg-no-repeat">
