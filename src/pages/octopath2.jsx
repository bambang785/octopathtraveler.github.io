  ...
  return (
    <section>
      <div class=" grid grid-cols-6 flex-col gap-6 md:grid-cols-2 lg:grid-cols-4 ">
        ...
        <div class=" max-w-screen-2xl col-start-1 col-end-7 mx-auto -mt-6 mb-10 h-full w-full flex-shrink-0 border-b-2 border-[#ECCA87] bg-map11  bg-cover bg-center bg-no-repeat">
