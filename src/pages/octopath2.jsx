      ...
      <div class=" grid grid-cols-6 ">
        ...
        >
          ...
          <p class="ml-10 mt-4 block w-full max-w-lg rounded bg-black text-center font-primary text-white opacity-70 sm:text-xl/relaxed">
            ...
            birth to new technologies. Some people thrill to glamorous stars of
            the stage and industry, while others are brought to tears by war,
            plague, and poverty. In this faraway realm, eight travelers hailing
            from different regions venture forth for their own reasons. Step
            into their shoes and explore the land as you see fit, using their
            unique talents to aid you along your journey. Embark on an adventure
            all your own.
          </p>
