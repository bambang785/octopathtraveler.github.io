    ...
    <Case>
      ...
      <div class=" relative mx-auto max-w-screen-xl bg-octopath1 bg-cover bg-center bg-no-repeat px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
        <div class="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
          ...
          <p class="mt-4 block w-full max-w-lg max-w-lg rounded bg-black font-primary font-primary text-white opacity-70 sm:text-xl/relaxed">
      ...
      <section class="   mx-30 container items-center  lg:flex-wrap"></section>
